...
- Status motion is limited to the Codex activity indicator; usage gauges remain stable and communicate state through value, label, and color together.
